...
import { parseCustomTheme } from "./theme";
...
test("validates portable theme definitions", () => {
  const definition = {
    colors: {
      ...
      danger: "#983c34", dangerSurface: "#f3dfdc", desktopText: "#ffffff", selection: "#96651d", editorBackground: "#f8f7f2",
      editorText: "#27302d", editorGutter: "#e8e8e1", editorKeyword: "#875d18", editorString: "#47735d", editorComment: "#606964",
    },
